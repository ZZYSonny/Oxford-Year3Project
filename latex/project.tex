...
\begin{cspinline}{semaphore.csp}{The binary semaphore module in CSP}
...
\begin{cspfloat}{monitor.csp}{The monitor module in CSP}
...
\begin{scalainline}{menwomen.scala.correct}{A correct MenWomen object implementation in Scala}
...
\begin{cspinline}{menwomen.csp.testsystem}{Definition of linearizer process in CSP}
Lin(All,me)= (
  Call!me!ManSync->
...
\begin{scalainline}{menwomen.scala.faulty}{A Faulty Scala implementation of MenWomen object}
